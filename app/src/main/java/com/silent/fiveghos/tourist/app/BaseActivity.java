package com.silent.fiveghos.tourist.app;
...
public abstract class BaseActivity extends AppCompatActivity{
    ...
    //是否有左侧滑栏
    protected boolean isHaveLeftMenu=false;
    //是否状态栏透明
     ...
     * 是否有左侧滑栏
     */
    public void setHaveLeftMenu(boolean haveLeftMenu){
        this.isHaveLeftMenu=haveLeftMenu;
    }
