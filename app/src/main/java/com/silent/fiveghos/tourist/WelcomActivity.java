...
import com.silent.fiveghos.tourist.utils.PrefUtils;
...
public class WelcomActivity extends AppCompatActivity {
     ...
     * 功能引导页展示的图片集合
     */
    private static int[] mImageIds = new int[]{R.mipmap.ic_launcher,
...
//        mDotDistance = mDotGroup.getChildAt(1).getLeft() - mDotGroup.getChildAt(0).getLeft();
        ...
        mVpGuide.setAdapter(new WelcomActivity.GuideAdapter());
        mVpGuide.setOnPageChangeListener(new WelcomActivity.GuidePageChangeListener());
