...
public class OrderContentActivity extends BaseActivity implements View.OnClickListener {
    ...
    private ImageView mReturn_order_content;
    ...
    protected void initView() {
        mReturn_order_content = findViewById(R.id.return_order_content);
        mReturn_order_content.setOnClickListener(this);
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.return_order_content:
                finish();
                break;
