package com.silent.fiveghost.tourist.widget.dynamiceffect.view;
...
import com.silent.fiveghost.tourist.widget.dynamiceffect.util.DensityUtil;


/**
 * 认真的人到最后都是难过 2017/12/23.
 */
...
public class PullToZoomListView extends ListView implements AbsListView.OnScrollListener {
    ...
    public void setmHeaderHeight(int mHeaderHeight) {
        ...
        LayoutParams lp = new LayoutParams(DensityUtil.dp2px(mContext,
